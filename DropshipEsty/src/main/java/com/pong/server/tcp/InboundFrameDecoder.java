...
import com.utils.Constants.FrameHelper;
...
public class InboundFrameDecoder extends ByteToMessageDecoder {
    ...
    public InboundFrameDecoder(String vtrackingFrameDecoder) {
        LOGGER = Logger.getLogger(vtrackingFrameDecoder + ".FrameDecoder");
    }
