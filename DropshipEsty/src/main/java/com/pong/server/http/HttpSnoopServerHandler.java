...
import com.pong.control.ProcessAuthenSvs;
import com.pong.control.ProcessInputControl;
import com.pong.control.ProcessInputLister;
...
//    private static Logger LOGGER;
    ...
    private HashMap<String, AliexStoreCommon> hashMap = new HashMap<>();
...
//                System.out.println("Key : " + entry.getKey() + " Value : " + entry.getValue());
            ...
            String[] dataParts = cleanData.split(Pattern.quote(","));
