    ...
    public void initValidValues(HashMap<String, ArrayList<String>> hashMap) {
        if (hashMap != null) {
            ...
            if (listValues != null && !listValues.isEmpty()) {
                ...
                variationThemeBoth = "SizeNameColorName";
                variationThemeColor = "ColorName";
                variationThemeSize = "SizeName";
            }
