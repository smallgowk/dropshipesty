...
//                    UIManager.setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel");
            ...
            java.util.logging.Logger.getLogger(OSUtil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        try {
            ...
            if (isMacOSX()) {
                Application.getApplication().setDockIconImage(icon.getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH));
            } else {
...
//            Process p = new ProcessBuilder(executeFile, (isWindows() ? "/select," : "/users,") + path).start();
    ...
    public static void initWebChrome() {
        String pathStr = null;
        if (OSUtil.isWindows()) {
